...
// Custom Fields 使っていない　プラグインがこのテーマに対応していない
$prelunch_price		= get_post_meta( 7, 'prelunch_price', true );
$lunch_price			= get_post_meta( 7, 'lunch_price', true );
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2">
					...
					<iframe width="100%" height="415" src="https://youtu.be/69nEzHLy_tM" frameborder="0" allowfullscreen></iframe>
				</div><!-- end col -->
			</div><!-- row -->			
		</div><!-- container -->
	</section><!-- featurette -->
